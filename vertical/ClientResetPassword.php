...
// $client_id = '3'; // Replace this with the actual agent ID
...
if (isset($_POST['submit'])) {
    ...
    $query = "SELECT password FROM client_details WHERE client_id = $client_id";
    ...
    if ($oldPassword ==  $storedPassword) {
        ...
        if ($newPassword === $confirmPassword) {
            ...
            $updateQuery = "UPDATE client_details SET password = '$updatedPassword' WHERE client_details.client_id = $client_id";
        ...
        $errorMessage = "Incorrect old passwefford.";
    }
